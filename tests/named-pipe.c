...
test_add_named_pipe (gconstpointer user_data)
{
  ...
  listener = wing_named_pipe_listener_new (test_data->use_iocp);
...
test_connect_basic (gconstpointer user_data)
{
  ...
  client = wing_named_pipe_client_new (test_data->use_iocp);
      ...
      char *argv[])
{
  ...
  test_data.read_write_fn = write_and_read_mix_sync_async;
  g_test_add_data_func ("/named-pipes/read-write-mix-sync-async-basic", &test_data, test_read_write_basic);
  g_test_add_data_func ("/named-pipes/read-write-mix-sync-async-several-connections", &test_data, test_read_write_several_connections);
  g_test_add_data_func ("/named-pipes/read-write-mix-sync-async-same-time-several-connections", &test_data, test_read_write_same_time_several_connections);

  /* I/O completion port tests */
  test_data.use_iocp = TRUE;
  g_test_add_data_func ("/named-pipes-iocp/add-named-pipe", &test_data, test_add_named_pipe);
  g_test_add_data_func ("/named-pipes-iocp/connect-basic", &test_data, test_connect_basic);
  g_test_add_data_func ("/named-pipes-iocp/connect-before-accept", &test_data, test_connect_before_accept);
  g_test_add_data_func ("/named-pipes-iocp/connect-sync", &test_data, test_connect_sync);
  g_test_add_data_func ("/named-pipes-iocp/connect-sync-fails", &test_data, test_connect_sync_fails);
  g_test_add_data_func ("/named-pipes-iocp/accept-cancel", &test_data, test_accept_cancel);
  g_test_add_data_func ("/named-pipes-iocp/connect-accept-cancel", &test_data, test_connect_accept_cancel);
  g_test_add_data_func ("/named-pipes-iocp/multi-client-basic", &test_data, test_multi_client_basic);
  g_test_add_data_func ("/named-pipes-iocp/client-default-timeout", &test_data, test_client_default_timeout);

  test_data.read_write_fn = write_and_read;
  g_test_add_data_func ("/named-pipes-iocp/read-write-basic", &test_data, test_read_write_basic);
  g_test_add_data_func ("/named-pipes-iocp/read-write-several-connections", &test_data, test_read_write_several_connections);
  g_test_add_data_func ("/named-pipes-iocp/read-write-same-time-several-connections", &test_data, test_read_write_same_time_several_connections);

  test_data.read_write_fn = write_and_read_mix_sync_async;
  g_test_add_data_func ("/named-pipes-iocp/read-write-mix-sync-async-basic", &test_data, test_read_write_basic);
  g_test_add_data_func ("/named-pipes-iocp/read-write-mix-sync-async-several-connections", &test_data, test_read_write_several_connections);
  g_test_add_data_func ("/named-pipes-iocp/read-write-mix-sync-async-same-time-several-connections", &test_data, test_read_write_same_time_several_connections);
